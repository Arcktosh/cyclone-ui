    ...
    input: [
        {
            ...
            children: <input type="email" placeholder="Email" className="input input-bordered" />
        }
    ]
}
    ...
    input: [
        {
            ...
            children: <input type="text" placeholder="0.01" className="input input-bordered" />
        }
    ]
}
...
GroupTextInputAndLabelVertically.args = {
    ...
    input: [
        {
            label: [{ text: 'Email', direction: 'left' }],
            children: <input type="text" placeholder="info@site.com" className="input input-bordered" />,
            vertical: true
        }
    ]
}
