...
const Drawer = (props: DrawerProps) => {
    ...
    return (
        <div className={`drawer${props.right ? ' drawer-end' : ''}`}>
            <input id={reference.toString()} type="checkbox" className="drawer-toggle" />
            <div className="drawer-content" style={props.contentStyle}>
                <label htmlFor={reference.toString()} className="btn btn-primary drawer-button">
                    {props.label}
                </label>
                {props.children}
            </div>
            <div className="drawer-side" style={props.sideStyle}>
                <label htmlFor={reference.toString()} className="drawer-overlay"></label>
