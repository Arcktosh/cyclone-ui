...
const QRCode = (props: QRCodeProps) => {
    ...
    if (props.vCard) {
        myVCard
            .addName(props.vCard?.lastname, props.vCard?.firstname, props.vCard?.additional, props.vCard?.prefix, props.vCard?.suffix)
            ...
            .addPhoneNumber(props.vCard.workPhone ? props.vCard.workPhone : '', 'PREF;WORK')
            .addPhoneNumber(props.vCard.workPhone ? props.vCard.workPhone : '', 'WORK')
            .addAddress(props.vCard?.company, props.vCard?.extended, props.vCard?.street, props.vCard?.city, props.vCard?.region, props.vCard?.zip, props.vCard?.country, props.vCard?.addressType)
    ...
    return props.imageSettings ? (
        <Code
            ...
            imageSettings={{
                ...
                excavate: props.imageSettings.excavate ? props.imageSettings.excavate : true
            }}
        />
    ) : (
        <Code
