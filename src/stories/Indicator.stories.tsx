...
EmptyBadge.args = {
    children: <div className="grid w-32 h-32 bg-base-300 place-items-center">content</div>
}

export const ForInput = Template.bind({})
ForInput.args = {
    title: 'Required',
    children: <input type="text" placeholder="Your email address" className="input input-bordered" />
}
